...
import { User, Mail, Phone, MapPin, Camera, Lock, Save, X, Shield, Calendar, Check, Truck } from 'lucide-react';
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div className="flex flex-col items-center">
                            <div className="relative mb-6">
                                ...
                                {isEditing && (
                                    <label className="absolute bottom-2 right-2 bg-green-600 text-white rounded-full p-3 cursor-pointer hover:bg-green-700 transition-colors shadow-lg">
                            ...
                            <div className="mt-4 px-4 py-2 bg-green-50 text-green-700 rounded-full text-sm font-medium capitalize">
                                <div className="flex items-center">
                            ...
                            {!isEditing && (
                                <button
                                    ...
                                    className="mt-6 w-full bg-green-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isUpdating}
                                >
                                    Modifier le profil
                                </button>
                                ...
                                <form onSubmit={handleProfileSubmit(onSubmitProfile)} className="space-y-6">
                                    ...
                                    <div className="flex justify-end space-x-4 pt-4">
                                        ...
                                        <button
                                            ...
                                            className="px-5 py-2.5 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            {isUpdating ? (
                                                <>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="text-green-600 hover:text-green-800 font-medium flex items-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isUpdating}
                                >
