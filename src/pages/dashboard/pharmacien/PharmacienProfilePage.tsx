...
import { User, Mail, Phone, MapPin, Camera, Lock, Save, X, Shield, Calendar, Check, Building2 } from 'lucide-react';
...
const PharmacienProfilePage: React.FC = () => {
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div className="flex flex-col items-center">
                            <div className="relative mb-6">
                                ...
                                {isEditing && (
                                    <label className="absolute bottom-2 right-2 bg-blue-600 text-white rounded-full p-3 cursor-pointer hover:bg-blue-700 transition-colors shadow-lg">
                            ...
                            <div className="mt-4 px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium capitalize">
                                <div className="flex items-center">
                            ...
                            {!isEditing && (
                                <button
                                    ...
                                    className="mt-6 w-full bg-blue-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isUpdating}
                                >
                                    Modifier le profil
                                </button>
                                ...
                                {user.pharmacy && (
                                    <>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-medium text-sm">{user.pharmacy.name}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-gray-600">ID Pharmacie</span>
                                            <span className="font-mono text-xs">#{user.pharmacy.id}</span>
                                        </div>
                                    </>
                                )}
                            </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="text-blue-600 hover:text-blue-800 font-medium flex items-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isUpdating}
                                >
...
export default PharmacienProfilePage;
